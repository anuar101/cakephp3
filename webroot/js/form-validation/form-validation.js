    ...
    function(a) {
        ...
        var b = {
            ...
            setInlineMessage: function(b, c, d) {
				...
				// Dynamic message 
				// Aurtor : Bhavin d solanki
				c = c.replace(/{{field_name}}/g, b.attr("title"));
				c = c.replace(/{{maxlength}}/g, b.attr("maxlength"));
				c = c.replace(/{{minlength}}/g, b.attr("minlength"));
                                c = c.replace(/{{filetype}}/g, b.attr("filetype"));
                                c = c.replace(/{{file_size}}/g, b.attr("file_size"));
                                c = c.replace(/{{filedimenstion}}/g, b.attr("filedimenstion"));
